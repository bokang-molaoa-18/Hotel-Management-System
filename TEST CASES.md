...
|--------------|----------------|---------------------------------|-----------------------------------------------------------------------|--------------------------------------------------|----------------|--------------------|
| TC-001       | FR-001         | Guest books a room              | 1. Select dates<br>2. Choose room type<br>3. Enter guest details<br>4. Confirm payment | Confirmation email sent<br>Room status: Reserved | ...            | ...                |
| TC-002       | FR-003         | Staff processes check-in         | 1. Scan booking ID<br>2. Verify payment status<br>3. Assign room key  | Room status: Occupied<br>Housekeeping notified   | ...            | ...                |
| TC-003       | FR-005         | Guest modifies reservation       | 1. Log in to account<br>2. Edit booking dates<br>3. Resubmit payment  | Updated confirmation sent<br>Inventory adjusted  | ...            | ...                |
| TC-004       | FR-007         | System prevents overbooking      | 1. Attempt to book already reserved dates                            | "No availability" error displayed                | ...            | ...                |
| TC-005       | FR-009         | Guest requests room service      | 1. Select service type<br>2. Submit request                          | Request logged<br>Staff alert triggered          | ...            | ...                |
| TC-006       | FR-012         | Generate financial report        | 1. Select date range<br>2. Filter by room type<br>3. Export as PDF    | Report generated with accurate revenue data      | ...            | ...                |
| TC-007       | FR-014         | Third-party booking sync          | 1. Create booking on external platform<br>2. Refresh system          | Booking appears in system ≤3s                   | ...            | ...                |
| TC-008       | FR-017         | Process payment failure           | 1. Enter invalid card details<br>2. Submit payment                   | "Payment failed" error<br>Reservation not created | ...            | ...                |
